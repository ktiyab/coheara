...
<script lang="ts">
  ...
  const relievingKeys: Record<string, string> = {
    ...
    'Position change': 'journal.expanded_relieving_position_change',
...
<div class="flex flex-col gap-6">
  <!-- Body region -->
  <div>
    <h3 class="text-sm font-medium text-stone-600 mb-2">{$t('journal.expanded_body_title')}</h3>
  ...
  <!-- Duration -->
  <div>
    <h3 class="text-sm font-medium text-stone-600 mb-2">{$t('journal.expanded_duration_title')}</h3>
  ...
  <!-- Character -->
  <div>
    <h3 class="text-sm font-medium text-stone-600 mb-2">{$t('journal.expanded_character_title')}</h3>
    <div class="flex gap-2">
  ...
  <!-- Aggravating factors -->
  <div>
    <h3 class="text-sm font-medium text-stone-600 mb-2">{$t('journal.expanded_aggravating_title')}</h3>
    <div class="flex flex-wrap gap-2">
  ...
  <!-- Relieving factors -->
  <div>
    <h3 class="text-sm font-medium text-stone-600 mb-2">{$t('journal.expanded_relieving_title')}</h3>
    <div class="flex flex-wrap gap-2">
  ...
  <!-- Timing pattern -->
  <div>
    <h3 class="text-sm font-medium text-stone-600 mb-2">{$t('journal.expanded_timing_title')}</h3>
    <div class="flex flex-wrap gap-2">
