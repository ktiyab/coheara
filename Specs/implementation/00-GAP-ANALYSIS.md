...
| ID | Title | Domain | File | Impact | Status |
|----|-------|--------|------|--------|--------|
| IMP-003 | Implement ONNX embedding model | embedding | `src-tauri/src/pipeline/storage/embedder.rs` | No semantic search; RAG returns only structured data | PENDING |
